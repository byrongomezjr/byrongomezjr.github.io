  ...
  return (
    ...
    className="relative flex flex-col items-center h-screen px-8 mx-auto text-center md:text-left md:flex-row max-w-7xl justify-evenly">
        ...
        <div className="px-0 space-y-8 md:px-8">
            ...
            <p className="text-md">
            I am a Computer Science student at Rutgers, The State University of New Jersey; and form part of the school&apos;s Computer Science club - currently on my second year. I love implementing responsiveness and clean design to personal projects such as mobile and web apps that live on the internet; My interests range from Software Engineering to Machine Learning.
            </p>
        </div>
        </motion.div>
  )
